...
export type KeystoreListReducer = IBasicReducer<KeystoreListPayLoad, BaseAccount[], string>;
export type KeystoreUpdateReducer = IBasicReducer<KeystoreUpdatePayLoad, BaseAccount, string>;
export type KeystoreCreateReducer = IBasicReducer<KeystoreCreatePayLoad, BaseAccount, string>;
...
const KeystoreReducer = combineReducers({
	...
	create: keystore.SimpleReducer<KeystoreCreatePayLoad, BaseAccount, string>('Create')
});
