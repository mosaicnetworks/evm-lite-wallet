...
> {
	...
	public render() {
		const json = {
			...
			crypto: {
				ciphertext:
					'f8263181ad9b47254ba7813fcb197b7d58ea31e71b35ae421b3e5ae404afea10',
				...
				kdfparams: {
					dklen: 32,
					salt:
						'7e72d9e93ec971670d76f6462086c06114cf12f183dbac65ef86ccacdef0390d',
					n: 8192,
					r: 8,
					p: 1
				},
				mac:
					'4bee2ee347a497a3afb25712c2f74faa3940ce86ef8b2022b197e9f0cef6df98'
			}
		};
		return (
			<React.Fragment>
